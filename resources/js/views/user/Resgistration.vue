...
align-items: center;">
        <div class="w-25" style="margin-top: 50px; margin-bottom: 50px; ">
            ...
            <input class="form-control mt-3 mb-3" type="email" name="email" v-model="email" placeholder="Электронная почта">
