                ...
                <form action="{{ route('admin.product.update', $product->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="name" value="{{$product->name}}" type="text" name="name" class="form-control">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input id="description" value="{{$product->description}}" type="text" name="description"
                                   class="form-control">
                            @error('description')
                            <div class="text-danger">
                                Это поле необходимо для заполнения
                        ...
                        <div class="form-group">
                            ...
                            <input id="content" value="{{$product->content}}" type="text" name="content"
                                   class="form-control">
                            @error('content')
                            <div class="text-danger">
                                Это поле необходимо для заполнения
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    <input type="file" value="{{$product->preview_image}}" class="custom-file-input" name="preview_image">
                        ...
                        <div class="form-group">
                            ...
                            <input id="price" value="{{$product->price}}" type="number" name="price" class="form-control">
                            @error('price')
                            <div class="text-danger">
                                Это поле необходимо для заполнения
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="count" value="{{$product->count}}" type="number" name="count"
                                   class="form-control">
                            @error('count')
                            <div class="text-danger">
                                Это поле необходимо для заполнения
                        ...
                        <div class="form-group">
                            ...
                            <select name="is_published" class="custom-select form-control" id="exampleSelectBorder">
                                ...
                                <option {{$product->is_published == 2 ? ' selected' : '' }} value="2">Нет</option>
                            </select>
                            @error('is_published')
                            <div class="text-danger">
                                Это поле необходимо для заполнения
